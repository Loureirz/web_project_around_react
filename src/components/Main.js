...
export default function Main() {
    return (
      ...
      <section className="profile">
        <button type="submit" className="profile__image-edit">
        ...
        <div className="popup form" id="popup-user">
          ...
          <div className="popup__container">
            <button className="popup__close"><img src="<%= require('./image/close.svg')%>" alt="icone de fechar"
        ...
        <div className="popup" id="popup-avatar">
          ...
          <div className="popup__avatar">
            <button className="popup__close"><img src="<%= require('./image/close.svg')%>" alt="icone de fechar" className="popup__close-img"/></button>
        ...
        <template id="template">
          <div className="elements__card">
            <button type="button" className="elements__delete-button">
              <img className="elements__delete-icon" src="<%= require('./image/Trash.svg')%>" alt="delete button icon" />
            </button>
